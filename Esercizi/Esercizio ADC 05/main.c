...
#define N_ARR2 800//acquisizione: 8000000/1000
#define N_ARR1 800 //generazione
//Registri ADC
...
TIM2->ARR=N_ARR1;
TIM3->ARR=N_ARR2; //mi serve un altro timer per ADC
...
punt=ADC1_ISR;
         ...
         if(((t)&(1<<9))==(1<<9)){
           ...
           //calcola veff
           x1=0.0;
           for(int j=0;j<100;j++) x1+=((v[j])*(v[j]));
           x1=sqrt(x1/100);
           printf("veff: %.2f\n", x1);
          // printf("test\n");
           //riabbasso ifcr
